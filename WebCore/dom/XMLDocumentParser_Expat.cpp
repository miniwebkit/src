...
void XMLDocumentParser::handleError(ErrorType type, const char* m, TextPosition1 position)
{
    ...
    WTFReportFatalError(__FILE__, __LINE__, WTF_PRETTY_FUNCTION, "%", m);
}
...
void XMLDocumentParser::exitText()
{
    ...
    static_cast<Text*>(m_currentNode)->appendData(m_bufferedText, ec);
    m_bufferedText = "";
#endif
...
void XMLDocumentParser::end()
{
    ...
    Test_addAllNodeRenderStyle (document(), (SVGDocument *)m_currentNode);
