...
#endif
void   qt_set_sequence_auto_mnemonic(bool b) { qt_sequence_no_mnemonics = !b; }
...
//   StandardKey                            Priority    Key Sequence                            Platforms
    {QKeySequence::Back,                    0,          Qt::Key_Backspace,                      KApp::KB_Win},
    {QKeySequence::InsertParagraphSeparator,0,          Qt::Key_Return,                         KApp::KB_All},
    {QKeySequence::InsertParagraphSeparator,0,          Qt::Key_Enter,                          KApp::KB_All},
    {QKeySequence::Delete,                  1,          Qt::Key_Delete,                         KApp::KB_All},
    {QKeySequence::MoveToStartOfLine,       0,          Qt::Key_Home,                           KApp::KB_Win | KApp::KB_X11 | KApp::KB_S60},
    {QKeySequence::MoveToStartOfDocument,   0,          Qt::Key_Home,                           KApp::KB_Mac},
    {QKeySequence::MoveToEndOfLine,         0,          Qt::Key_End,                            KApp::KB_Win | KApp::KB_X11 | KApp::KB_S60},
    {QKeySequence::MoveToEndOfDocument,     0,          Qt::Key_End,                            KApp::KB_Mac},
    {QKeySequence::MoveToPreviousChar,      0,          Qt::Key_Left,                           KApp::KB_All},
    {QKeySequence::MoveToPreviousLine,      0,          Qt::Key_Up,                             KApp::KB_All},
    {QKeySequence::MoveToNextChar,          0,          Qt::Key_Right,                          KApp::KB_All},
    {QKeySequence::MoveToNextLine,          0,          Qt::Key_Down,                           KApp::KB_All},
    {QKeySequence::MoveToPreviousPage,      1,          Qt::Key_PageUp,                         KApp::KB_All},
    {QKeySequence::MoveToNextPage,          1,          Qt::Key_PageDown,                       KApp::KB_All},
    {QKeySequence::HelpContents,            0,          Qt::Key_F1,                             KApp::KB_Win | KApp::KB_X11},
    {QKeySequence::HelpContents,            0,          Qt::Key_F2,                             KApp::KB_S60},
    {QKeySequence::FindNext,                0,          Qt::Key_F3,                             KApp::KB_X11},
    {QKeySequence::FindNext,                1,          Qt::Key_F3,                             KApp::KB_Win},
    {QKeySequence::Refresh,                 0,          Qt::Key_F5,                             KApp::KB_Win | KApp::KB_X11},
    {QKeySequence::Undo,                    0,          Qt::Key_F14,                            KApp::KB_X11}, //Undo on sun keyboards
    {QKeySequence::Copy,                    0,          Qt::Key_F16,                            KApp::KB_X11}, //Copy on sun keyboards
    {QKeySequence::Paste,                   0,          Qt::Key_F18,                            KApp::KB_X11}, //Paste on sun keyboards      
    {QKeySequence::Cut,                     0,          Qt::Key_F20,                            KApp::KB_X11}, //Cut on sun keyboards
    {QKeySequence::PreviousChild,           0,          Qt::Key_Back,                           KApp::KB_All},
    {QKeySequence::NextChild,               0,          Qt::Key_Forward,                        KApp::KB_All}, 
    {QKeySequence::Forward,                 0,          Qt::SHIFT | Qt::Key_Backspace,          KApp::KB_Win},
    {QKeySequence::Delete,                  0,          Qt::SHIFT | Qt::Key_Backspace,          KApp::KB_S60},
    {QKeySequence::InsertLineSeparator,     0,          Qt::SHIFT | Qt::Key_Return,             KApp::KB_All},
    {QKeySequence::InsertLineSeparator,     0,          Qt::SHIFT | Qt::Key_Enter,              KApp::KB_All},
    {QKeySequence::Paste,                   0,          Qt::SHIFT | Qt::Key_Insert,             KApp::KB_Win | KApp::KB_X11}, 
    {QKeySequence::Cut,                     0,          Qt::SHIFT | Qt::Key_Delete,             KApp::KB_Win | KApp::KB_X11}, //## Check if this should work on mac
    {QKeySequence::SelectStartOfLine,       0,          Qt::SHIFT | Qt::Key_Home,               KApp::KB_Win | KApp::KB_X11 | KApp::KB_S60},
    {QKeySequence::SelectStartOfDocument,   0,          Qt::SHIFT | Qt::Key_Home,               KApp::KB_Mac},
    {QKeySequence::SelectEndOfLine,         0,          Qt::SHIFT | Qt::Key_End,                KApp::KB_Win | KApp::KB_X11 | KApp::KB_S60},
    {QKeySequence::SelectEndOfDocument,     0,          Qt::SHIFT | Qt::Key_End,                KApp::KB_Mac},
    {QKeySequence::SelectPreviousChar,      0,          Qt::SHIFT | Qt::Key_Left,               KApp::KB_All},
    {QKeySequence::SelectPreviousLine,      0,          Qt::SHIFT | Qt::Key_Up,                 KApp::KB_All},
    {QKeySequence::SelectNextChar,          0,          Qt::SHIFT | Qt::Key_Right,              KApp::KB_All},
    {QKeySequence::SelectNextLine,          0,          Qt::SHIFT | Qt::Key_Down,               KApp::KB_All},
    {QKeySequence::SelectPreviousPage,      0,          Qt::SHIFT | Qt::Key_PageUp,             KApp::KB_All},
    {QKeySequence::SelectNextPage,          0,          Qt::SHIFT | Qt::Key_PageDown,           KApp::KB_All},
    {QKeySequence::WhatsThis,               1,          Qt::SHIFT | Qt::Key_F1,                 KApp::KB_All},
    {QKeySequence::FindPrevious,            0,          Qt::SHIFT | Qt::Key_F3,                 KApp::KB_X11},
    {QKeySequence::FindPrevious,            1,          Qt::SHIFT | Qt::Key_F3,                 KApp::KB_Win},
    {QKeySequence::ZoomIn,                  1,          Qt::CTRL | Qt::Key_Plus,                KApp::KB_All},
    {QKeySequence::NextChild,               0,          Qt::CTRL | Qt::Key_Comma,               KApp::KB_KDE},
    {QKeySequence::Preferences,             0,          Qt::CTRL | Qt::Key_Comma,               KApp::KB_Mac},
    {QKeySequence::ZoomOut,                 1,          Qt::CTRL | Qt::Key_Minus,               KApp::KB_All},
    {QKeySequence::PreviousChild,           0,          Qt::CTRL | Qt::Key_Period,              KApp::KB_KDE},
    {QKeySequence::HelpContents,            1,          Qt::CTRL | Qt::Key_Question,            KApp::KB_Mac},
    {QKeySequence::SelectAll,               1,          Qt::CTRL | Qt::Key_A,                   KApp::KB_All},
    {QKeySequence::Bold,                    1,          Qt::CTRL | Qt::Key_B,                   KApp::KB_All},
    {QKeySequence::Copy,                    1,          Qt::CTRL | Qt::Key_C,                   KApp::KB_All},
    {QKeySequence::Delete,                  0,          Qt::CTRL | Qt::Key_D,                   KApp::KB_X11}, //emacs (line edit only)
    {QKeySequence::Find,                    0,          Qt::CTRL | Qt::Key_F,                   KApp::KB_All},
    {QKeySequence::FindNext,                1,          Qt::CTRL | Qt::Key_G,                   KApp::KB_Gnome | KApp::KB_Mac},
    {QKeySequence::FindNext,                0,          Qt::CTRL | Qt::Key_G,                   KApp::KB_Win},
    {QKeySequence::Replace,                 0,          Qt::CTRL | Qt::Key_H,                   KApp::KB_Win}, 
    {QKeySequence::Replace,                 0,          Qt::CTRL | Qt::Key_H,                   KApp::KB_Gnome}, 
    {QKeySequence::Italic,                  0,          Qt::CTRL | Qt::Key_I,                   KApp::KB_All}, 
    {QKeySequence::DeleteEndOfLine,         0,          Qt::CTRL | Qt::Key_K,                   KApp::KB_X11}, //emacs (line edit only)
    {QKeySequence::New,                     1,          Qt::CTRL | Qt::Key_N,                   KApp::KB_All},
    {QKeySequence::Open,                    1,          Qt::CTRL | Qt::Key_O,                   KApp::KB_All},
    {QKeySequence::Print,                   1,          Qt::CTRL | Qt::Key_P,                   KApp::KB_All},
    {QKeySequence::Quit,                    0,          Qt::CTRL | Qt::Key_Q,                   KApp::KB_Gnome | KApp::KB_KDE | KApp::KB_Mac},
    {QKeySequence::Refresh,                 1,          Qt::CTRL | Qt::Key_R,                   KApp::KB_Gnome | KApp::KB_Mac},
    {QKeySequence::Replace,                 0,          Qt::CTRL | Qt::Key_R,                   KApp::KB_KDE},
    {QKeySequence::Save,                    1,          Qt::CTRL | Qt::Key_S,                   KApp::KB_All},
    {QKeySequence::AddTab,                  0,          Qt::CTRL | Qt::Key_T,                   KApp::KB_All},
    {QKeySequence::Underline,               1,          Qt::CTRL | Qt::Key_U,                   KApp::KB_All}, 
    {QKeySequence::Paste,                   1,          Qt::CTRL | Qt::Key_V,                   KApp::KB_All},
    {QKeySequence::Close,                   0,          Qt::CTRL | Qt::Key_W,                   KApp::KB_Win | KApp::KB_X11},
    {QKeySequence::Close,                   1,          Qt::CTRL | Qt::Key_W,                   KApp::KB_Mac},
    {QKeySequence::Cut,                     1,          Qt::CTRL | Qt::Key_X,                   KApp::KB_All},
    {QKeySequence::Redo,                    1,          Qt::CTRL | Qt::Key_Y,                   KApp::KB_Win | KApp::KB_S60},
    {QKeySequence::Undo,                    1,          Qt::CTRL | Qt::Key_Z,                   KApp::KB_All},
    {QKeySequence::Back,                    1,          Qt::CTRL | Qt::Key_BracketLeft,         KApp::KB_Mac},
    {QKeySequence::Forward,                 1,          Qt::CTRL | Qt::Key_BracketRight,        KApp::KB_Mac},
    {QKeySequence::PreviousChild,           1,          Qt::CTRL | Qt::Key_BraceLeft,           KApp::KB_Mac},
    {QKeySequence::NextChild,               1,          Qt::CTRL | Qt::Key_BraceRight,          KApp::KB_Mac},
    {QKeySequence::NextChild,               1,          Qt::CTRL | Qt::Key_Tab,                 KApp::KB_Win | KApp::KB_X11},
    {QKeySequence::NextChild,               0,          Qt::CTRL | Qt::Key_Tab,                 KApp::KB_Mac}, //different priority from above
    {QKeySequence::DeleteStartOfWord,       0,          Qt::CTRL | Qt::Key_Backspace,           KApp::KB_X11 | KApp::KB_Win},
    {QKeySequence::Copy,                    0,          Qt::CTRL | Qt::Key_Insert,              KApp::KB_X11 | KApp::KB_Win}, 
    {QKeySequence::DeleteEndOfWord,         0,          Qt::CTRL | Qt::Key_Delete,              KApp::KB_X11 | KApp::KB_Win},
    {QKeySequence::MoveToStartOfDocument,   0,          Qt::CTRL | Qt::Key_Home,                KApp::KB_Win | KApp::KB_X11 | KApp::KB_S60},
    {QKeySequence::MoveToEndOfDocument,     0,          Qt::CTRL | Qt::Key_End,                 KApp::KB_Win | KApp::KB_X11 | KApp::KB_S60},
    {QKeySequence::Back,                    0,          Qt::CTRL | Qt::Key_Left,                KApp::KB_Mac}, 
    {QKeySequence::MoveToPreviousWord,      0,          Qt::CTRL | Qt::Key_Left,                KApp::KB_Win | KApp::KB_X11 | KApp::KB_S60},
    {QKeySequence::MoveToStartOfLine,       0,          Qt::CTRL | Qt::Key_Left,                KApp::KB_Mac },
    {QKeySequence::MoveToStartOfDocument,   1,          Qt::CTRL | Qt::Key_Up,                  KApp::KB_Mac},
    {QKeySequence::Forward,                 0,          Qt::CTRL | Qt::Key_Right,               KApp::KB_Mac}, 
    {QKeySequence::MoveToEndOfLine,         0,          Qt::CTRL | Qt::Key_Right,               KApp::KB_Mac },
    {QKeySequence::MoveToNextWord,          0,          Qt::CTRL | Qt::Key_Right,               KApp::KB_Win | KApp::KB_X11 | KApp::KB_S60},
    {QKeySequence::MoveToEndOfDocument,     1,          Qt::CTRL | Qt::Key_Down,                KApp::KB_Mac},
    {QKeySequence::Close,                   1,          Qt::CTRL | Qt::Key_F4,                  KApp::KB_Win},
    {QKeySequence::Close,                   0,          Qt::CTRL | Qt::Key_F4,                  KApp::KB_Mac},
    {QKeySequence::NextChild,               0,          Qt::CTRL | Qt::Key_F6,                  KApp::KB_Win},
    {QKeySequence::FindPrevious,            1,          Qt::CTRL | Qt::SHIFT | Qt::Key_G,       KApp::KB_Gnome | KApp::KB_Mac},
    {QKeySequence::FindPrevious,            0,          Qt::CTRL | Qt::SHIFT | Qt::Key_G,       KApp::KB_Win},
    {QKeySequence::AddTab,                  1,          Qt::CTRL | Qt::SHIFT | Qt::Key_N,       KApp::KB_KDE},
    {QKeySequence::SaveAs,                  0,          Qt::CTRL | Qt::SHIFT | Qt::Key_S,       KApp::KB_Gnome | KApp::KB_Mac},
    {QKeySequence::Redo,                    0,          Qt::CTRL | Qt::SHIFT | Qt::Key_Z,       KApp::KB_Win | KApp::KB_X11 | KApp::KB_S60},
    {QKeySequence::Redo,                    0,          Qt::CTRL | Qt::SHIFT | Qt::Key_Z,       KApp::KB_Mac},
    {QKeySequence::PreviousChild,           1,          Qt::CTRL | Qt::SHIFT | Qt::Key_Backtab, KApp::KB_Win | KApp::KB_X11},
    {QKeySequence::PreviousChild,           0,          Qt::CTRL | Qt::SHIFT | Qt::Key_Backtab, KApp::KB_Mac },//different priority from above 
    {QKeySequence::Paste,                   0,          Qt::CTRL | Qt::SHIFT | Qt::Key_Insert,  KApp::KB_X11},
    {QKeySequence::SelectStartOfDocument,   0,          Qt::CTRL | Qt::SHIFT | Qt::Key_Home,    KApp::KB_Win | KApp::KB_X11 | KApp::KB_S60},
    {QKeySequence::SelectEndOfDocument,     0,          Qt::CTRL | Qt::SHIFT | Qt::Key_End,     KApp::KB_Win | KApp::KB_X11 | KApp::KB_S60},
    {QKeySequence::SelectPreviousWord,      0,          Qt::CTRL | Qt::SHIFT | Qt::Key_Left,    KApp::KB_Win | KApp::KB_X11 | KApp::KB_S60},
    {QKeySequence::SelectStartOfLine,       1,          Qt::CTRL | Qt::SHIFT | Qt::Key_Left,    KApp::KB_Mac },
    {QKeySequence::SelectStartOfDocument,   1,          Qt::CTRL | Qt::SHIFT | Qt::Key_Up,      KApp::KB_Mac},
    {QKeySequence::SelectNextWord,          0,          Qt::CTRL | Qt::SHIFT | Qt::Key_Right,   KApp::KB_Win | KApp::KB_X11 | KApp::KB_S60},
    {QKeySequence::SelectEndOfLine,         1,          Qt::CTRL | Qt::SHIFT | Qt::Key_Right,   KApp::KB_Mac },
    {QKeySequence::SelectEndOfDocument,     1,          Qt::CTRL | Qt::SHIFT | Qt::Key_Down,    KApp::KB_Mac},
    {QKeySequence::PreviousChild,           0,          Qt::CTRL | Qt::SHIFT | Qt::Key_F6,      KApp::KB_Win},
    {QKeySequence::Undo,                    0,          Qt::ALT  | Qt::Key_Backspace,           KApp::KB_Win},
    {QKeySequence::DeleteStartOfWord,       0,          Qt::ALT  | Qt::Key_Backspace,           KApp::KB_Mac},
    {QKeySequence::DeleteEndOfWord,         0,          Qt::ALT  | Qt::Key_Delete,              KApp::KB_Mac},    
    {QKeySequence::Back,                    1,          Qt::ALT  | Qt::Key_Left,                KApp::KB_Win | KApp::KB_X11},
    {QKeySequence::MoveToPreviousWord,      0,          Qt::ALT  | Qt::Key_Left,                KApp::KB_Mac},
    {QKeySequence::MoveToStartOfBlock,      0,          Qt::ALT  | Qt::Key_Up,                  KApp::KB_Mac}, //mac only
    {QKeySequence::MoveToNextWord,          0,          Qt::ALT  | Qt::Key_Right,               KApp::KB_Mac},
    {QKeySequence::Forward,                 1,          Qt::ALT  | Qt::Key_Right,               KApp::KB_Win | KApp::KB_X11},
    {QKeySequence::MoveToEndOfBlock,        0,          Qt::ALT  | Qt::Key_Down,                KApp::KB_Mac}, //mac only
    {QKeySequence::MoveToPreviousPage,      0,          Qt::ALT  | Qt::Key_PageUp,              KApp::KB_Mac },
    {QKeySequence::MoveToNextPage,          0,          Qt::ALT  | Qt::Key_PageDown,            KApp::KB_Mac },
    {QKeySequence::Redo,                    0,          Qt::ALT  | Qt::SHIFT | Qt::Key_Backspace,KApp::KB_Win},
    {QKeySequence::SelectPreviousWord,      0,          Qt::ALT  | Qt::SHIFT | Qt::Key_Left,    KApp::KB_Mac},
    {QKeySequence::SelectStartOfBlock,      0,          Qt::ALT  | Qt::SHIFT | Qt::Key_Up,      KApp::KB_Mac}, //mac only
    {QKeySequence::SelectNextWord,          0,          Qt::ALT  | Qt::SHIFT | Qt::Key_Right,   KApp::KB_Mac},
    {QKeySequence::SelectEndOfBlock,        0,          Qt::ALT  | Qt::SHIFT | Qt::Key_Down,    KApp::KB_Mac}, //mac only
    {QKeySequence::MoveToStartOfBlock,      0,          Qt::META | Qt::Key_A,                   KApp::KB_Mac},
    {QKeySequence::Delete,                  0,          Qt::META | Qt::Key_D,                   KApp::KB_Mac},
    {QKeySequence::MoveToEndOfBlock,        0,          Qt::META | Qt::Key_E,                   KApp::KB_Mac},
    {QKeySequence::InsertLineSeparator,     0,          Qt::META | Qt::Key_Return,              KApp::KB_Mac},
    {QKeySequence::InsertLineSeparator,     0,          Qt::META | Qt::Key_Enter,               KApp::KB_Mac},
    {QKeySequence::MoveToStartOfLine,       0,          Qt::META | Qt::Key_Left,                KApp::KB_Mac},
    {QKeySequence::MoveToPreviousPage,      0,          Qt::META | Qt::Key_Up,                  KApp::KB_Mac},
    {QKeySequence::MoveToEndOfLine,         0,          Qt::META | Qt::Key_Right,               KApp::KB_Mac},
    {QKeySequence::MoveToNextPage,          0,          Qt::META | Qt::Key_Down,                KApp::KB_Mac},
    {QKeySequence::MoveToPreviousPage,      0,          Qt::META | Qt::Key_PageUp,              KApp::KB_Mac},
    {QKeySequence::MoveToNextPage,          0,          Qt::META | Qt::Key_PageDown,            KApp::KB_Mac},
    {QKeySequence::SelectStartOfBlock,      0,          Qt::META | Qt::SHIFT | Qt::Key_A,       KApp::KB_Mac},
    {QKeySequence::SelectEndOfBlock,        0,          Qt::META | Qt::SHIFT | Qt::Key_E,       KApp::KB_Mac},
    {QKeySequence::SelectStartOfLine,       0,          Qt::META | Qt::SHIFT | Qt::Key_Left,    KApp::KB_Mac},
    {QKeySequence::SelectEndOfLine,         0,          Qt::META | Qt::SHIFT | Qt::Key_Right,   KApp::KB_Mac}    
};
...
{
    uint platform = KApp::currentPlatform();
...
int QKeySequencePrivate::decodeString(const QString &str, QKeySequence::SequenceFormat format)
{
    ...
    if (nativeText) {
        modifs << QModifKeyName(Qt::CTRL, QString::fromLatin1/*tr*/("Ctrl").toLower().append(QLatin1Char('+')))
               << QModifKeyName(Qt::SHIFT, QString::fromLatin1/*tr*/("Shift").toLower().append(QLatin1Char('+')))
               << QModifKeyName(Qt::ALT, QString::fromLatin1/*tr*/("Alt").toLower().append(QLatin1Char('+')))
               << QModifKeyName(Qt::META, QString::fromLatin1/*tr*/("Meta").toLower().append(QLatin1Char('+')));
    }
        ...
        for (int tran = 0; tran < 2; ++tran) {
            ...
            for (int i = 0; keyname[i].name; ++i) {
                QString keyName(tran == 0
                                ? QString::fromLatin1/*tr*/(keyname[i].name)
...
{
    if (!str.isEmpty())
        str += (format == QKeySequence::NativeText) ? QString::fromLatin1/*tr*/("+")
                                                    : QString::fromLatin1("+");
    str += theKey;
}
...
QString QKeySequencePrivate::encodeString(int key, QKeySequence::SequenceFormat format)
{
...
#endif
    {
        ...
        if ((key & Qt::META) == Qt::META)
            s = nativeText ? QString::fromLatin1/*tr*/("Meta") : QString::fromLatin1("Meta");
        if ((key & Qt::CTRL) == Qt::CTRL)
            addKey(s, nativeText ? QString::fromLatin1/*tr*/("Ctrl") : QString::fromLatin1("Ctrl"), format);
        if ((key & Qt::ALT) == Qt::ALT)
            addKey(s, nativeText ? QString::fromLatin1/*tr*/("Alt") : QString::fromLatin1("Alt"), format);
        if ((key & Qt::SHIFT) == Qt::SHIFT)
            addKey(s, nativeText ? QString::fromLatin1/*tr*/("Shift") : QString::fromLatin1("Shift"), format);
    }
    ...
    if (key && key < Qt::Key_Escape && key != Qt::Key_Space) {
        if (!QChar::requiresSurrogates(key)) {
            ...
            p = nativeText ? QString::fromLatin1/*tr*/("F%1").arg(key - Qt::Key_F1 + 1)
...
NonSymbol:
            ...
            while (keyname[i].name) {
                if (key == keyname[i].key) {
                    p = nativeText ? QString::fromLatin1/*tr*/(keyname[i].name)
                                   : QString::fromLatin1(keyname[i].name);
                    break;
                }
                ++i;
