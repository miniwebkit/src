...
PassRefPtr<RenderTheme> RenderThemeChromiumLinux_create()
{
    return adoptRef(new RenderThemeChromiumSkia());
}

PassRefPtr<RenderTheme> RenderTheme::themeForPage(Page* page)
{
    // TODO_weolar
    static RenderTheme* rt = RenderThemeChromiumLinux_create().leakRef();
    return rt;
}
