...
{
    // Add by weolar
    if (attr->name() == SVGNames::onbeginAttr) {
        setAttributeEventListener(eventNames().beginEvent, createAttributeEventListener(document()->frame(), attr));
        return;
    } else if (attr->name() == SVGNames::onrepeatAttr) {
        setAttributeEventListener(eventNames().repeatEvent, createAttributeEventListener(document()->frame(), attr));
        return;
    } else if (attr->name() == SVGNames::onendAttr) {
        setAttributeEventListener(eventNames().endEvent, createAttributeEventListener(document()->frame(), attr));
        return;
