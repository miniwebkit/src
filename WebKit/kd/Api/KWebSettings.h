...
class /*QWEBKIT_EXPORT*/ KWebSettings {
public:
    enum FontFamily {
        StandardFont,
        FixedFont,
    ...
    static KWebSettings *globalSettings();
...
// 
//     inline KWebSettingsPrivate* handle() const { return d; }

private:
    //friend class QWebPagePrivate;
    friend class KWebSettingsPrivate;

    Q_DISABLE_COPY(KWebSettings)

    KWebSettings();
    KWebSettings(WebCore::Settings *settings);
    ~KWebSettings();

    KWebSettingsPrivate *d;
};
