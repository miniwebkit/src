...
/*!
    \class KWebElement
    \since 4.6
    \brief The KWebElement class provides convenient access to DOM elements in
    a QWebFrame.
    \inmodule QtWebKit

    A KWebElement object allows easy access to the document model, represented
    ...
    \snippet webkitsnippets/webelement/main.cpp Traversing with KWebElement
    ...
    The underlying content of KWebElement is explicitly shared. Creating a copy
    of a KWebElement does not create a copy of the content. Instead, both
...
/*!
    \internal
*/
KWebElement::KWebElement(WebCore::Element* domElement)
    : d(0)
...
/*!
    \internal
*/
KWebElement::KWebElement(WebCore::Node* node)
    : d(0)
    , m_element(0)
{
...
*/
KWebElement::KWebElement(const KWebElement &other)
    : d(0)
...
*/
KWebElement &KWebElement::operator=(const KWebElement &other)
{
    // ### handle "d" assignment
    if (this != &other) {
...
bool KWebElement::operator==(const KWebElement& o) const
{
...
/*!
    ...
    \sa findFirst()
*/
KWebElementCollection KWebElement::findAll(const QString &selectorQuery) const
{
    return KWebElementCollection(*this, selectorQuery);
}
...
/*!
    ...
    \sa findAll()
*/
KWebElement KWebElement::findFirst(const QString &selectorQuery) const
{
    if (!m_element)
        return KWebElement();
    ExceptionCode exception = 0; // ###
    return KWebElement(m_element->querySelector(selectorQuery, exception).get());
}
...
/*!
    ...
    \sa toPlainText()
*/
void KWebElement::setPlainText(const QString &text)
{
...
/*!
    ...
    \sa setPlainText()
*/
QString KWebElement::toPlainText() const
{
    if (!m_element || !m_element->isHTMLElement())
        return QString();
...
*/
void KWebElement::setOuterXml(const QString &markup)
{
    if (!m_element || !m_element->isHTMLElement())
        return;
...
*/
QString KWebElement::toOuterXml() const
{
    if (!m_element || !m_element->isHTMLElement())
        return QString();
...
*/
void KWebElement::setInnerXml(const QString &markup)
{
    if (!m_element || !m_element->isHTMLElement())
        return;
...
*/
QString KWebElement::toInnerXml() const
{
    if (!m_element || !m_element->isHTMLElement())
        return QString();
...
*/
void KWebElement::setAttribute(const QString &name, const QString &value)
{
    if (!m_element)
        return;
    ExceptionCode exception = 0;
...
*/
void KWebElement::setAttributeNS(const QString &namespaceUri, const QString &name, const QString &value)
{
    if (!m_element)
        return;
...
*/
QString KWebElement::attribute(const QString &name, const QString &defaultValue) const
{
    if (!m_element)
        return QString();
...
*/
QString KWebElement::attributeNS(const QString &namespaceUri, const QString &name, const QString &defaultValue) const
{
    if (!m_element)
        return QString();
...
*/
bool KWebElement::hasAttribute(const QString &name) const
{
    if (!m_element)
        return false;
...
*/
bool KWebElement::hasAttributeNS(const QString &namespaceUri, const QString &name) const
{
    if (!m_element)
        return false;
...
*/
void KWebElement::removeAttribute(const QString &name)
{
    if (!m_element)
        return;
    ExceptionCode exception = 0;
...
*/
void KWebElement::removeAttributeNS(const QString &namespaceUri, const QString &name)
{
    if (!m_element)
        return;
    WebCore::ExceptionCode exception = 0;
...
/*!
    ...
    \sa attribute(), setAttribute()
*/
bool KWebElement::hasAttributes() const
{
    if (!m_element)
        return false;
...
/*!
    ...
    \sa attribute(), setAttribute()
*/
QStringList KWebElement::attributeNames(const QString& namespaceUri) const
{
    if (!m_element)
        return QStringList();
...
/*!
    ...
    \sa setFocus()
*/
bool KWebElement::hasFocus() const
{
    if (!m_element)
        return false;
...
/*!
    ...
    \sa tagName()
*/
QRect KWebElement::geometry() const
{
    if (!m_element)
        return QRect();
...
/*!
    ...
    \sa geometry()
*/
QString KWebElement::tagName() const
{
    if (!m_element)
        return QString();
...
*/
QString KWebElement::prefix() const
{
    if (!m_element)
        return QString();
...
*/
QString KWebElement::localName() const
{
    if (!m_element)
        return QString();
...
*/
QString KWebElement::namespaceUri() const
{
    if (!m_element)
        return QString();
...
*/
KWebElement KWebElement::parent() const
{
    if (m_element)
        return KWebElement(m_element->parentElement());
    return KWebElement();
}
...
*/
KWebElement KWebElement::firstChild() const
{
    if (!m_element)
        return KWebElement();
...
*/
KWebElement KWebElement::lastChild() const
{
    if (!m_element)
        return KWebElement();
...
*/
KWebElement KWebElement::nextSibling() const
{
    if (!m_element)
        return KWebElement();
...
*/
KWebElement KWebElement::previousSibling() const
{
    if (!m_element)
        return KWebElement();
...
*/
KWebElement KWebElement::document() const
{
    if (!m_element)
        return KWebElement();
    ...
    if (!document)
        return KWebElement();
    return KWebElement(document->documentElement());
}
...
*/
KWebFrame *KWebElement::webFrame() const
{
    if (!m_element)
        return 0;
...
*/
QVariant KWebElement::evaluateJavaScript(const QString& scriptSource)
{
    __asm int 3; // weolar
...
/*!
    \enum KWebElement::StyleResolveStrategy

    This enum describes how KWebElement's styleProperty resolves the given
    property name.
...
QString KWebElement::styleProperty(const QString &name, StyleResolveStrategy strategy) const
{
...
*/
void KWebElement::setStyleProperty(const QString &name, const QString &value)
{
    if (!m_element || !m_element->isStyledElement())
        return;
...
*/
QStringList KWebElement::classes() const
{
...
/*!
    ...
    returns false.
*/
bool KWebElement::hasClass(const QString &name) const
{
...
*/
void KWebElement::addClass(const QString &name)
{
    QStringList list = classes();
...
*/
void KWebElement::removeClass(const QString &name)
{
    QStringList list = classes();
    if (list.contains(name)) {
        list.removeAll(name);
...
*/
void KWebElement::toggleClass(const QString &name)
{
    QStringList list = classes();
    if (list.contains(name))
        list.removeAll(name);
...
*/
void KWebElement::appendInside(const KWebElement &element)
{
...
/*!
    ...
    \sa prependInside(), prependOutside(), appendOutside()
*/
void KWebElement::appendInside(const QString &markup)
{
    if (!m_element)
        return;
...
*/
void KWebElement::prependInside(const KWebElement &element)
{
    if (!m_element || element.isNull())
        return;
...
/*!
    ...
    \sa appendInside(), prependOutside(), appendOutside()
*/
void KWebElement::prependInside(const QString &markup)
{
    if (!m_element)
        return;
...
*/
void KWebElement::prependOutside(const KWebElement &element)
{
    if (!m_element || element.isNull())
        return;
...
/*!
    ...
    \sa appendInside(), prependInside(), appendOutside()
*/
void KWebElement::prependOutside(const QString &markup)
{
    if (!m_element)
        return;
...
*/
void KWebElement::appendOutside(const KWebElement &element)
{
    if (!m_element || element.isNull())
        return;
...
/*!
    ...
    \sa appendInside(), prependInside(), prependOutside()
*/
void KWebElement::appendOutside(const QString &markup)
{
    if (!m_element)
        return;
...
*/
KWebElement KWebElement::clone() const
{
    if (!m_element)
        return KWebElement();

    return KWebElement(m_element->cloneElementWithChildren().get());
}
...
*/
KWebElement &KWebElement::takeFromDocument()
{
    if (!m_element)
        return *this;
...
*/
void KWebElement::removeFromDocument()
{
    if (!m_element)
        return;
...
*/
void KWebElement::removeAllChildren()
{
    if (!m_element)
        return;
...
/*!
    ...
    \sa encloseWith()
*/
void KWebElement::encloseContentsWith(const KWebElement &element)
{
    if (!m_element || element.isNull())
        return;
...
/*!
    ...
    \sa encloseWith()
*/
void KWebElement::encloseContentsWith(const QString &markup)
{
    if (!m_element)
        return;
...
/*!
    ...
    \sa replace()
*/
void KWebElement::encloseWith(const KWebElement &element)
{
    if (!m_element || element.isNull())
        return;
...
/*!
    ...
    \sa replace()
*/
void KWebElement::encloseWith(const QString &markup)
{
    if (!m_element)
        return;
...
/*!
    ...
    \sa encloseWith()
*/
void KWebElement::replace(const KWebElement &element)
{
    if (!m_element || element.isNull())
        return;
...
/*!
    ...
    \sa encloseWith()
*/
void KWebElement::replace(const QString &markup)
{
    if (!m_element)
        return;
...
/*!
    \internal
    Walk \a node's parents until a valid KWebElement is found.
    For example, a WebCore::Text node is not a valid Html KWebElement, but its
    enclosing p tag is.
*/
KWebElement KWebElement::enclosingElement(WebCore::Node* node)
{
    KWebElement element(node);

    while (element.isNull() && node) {
        node = node->parentNode();
        element = KWebElement(node);
    }
    return element;
}

/*!
    \fn inline bool KWebElement::operator==(const KWebElement& o) const;
...
*/
void KWebElement::render(QPainter* painter)
{
...
*/
void KWebElement::render(QPainter* painter, const QRect& clip)
{
...
class KWebElementCollectionPrivate : public QSharedData
{
public:
    static KWebElementCollectionPrivate* create(const PassRefPtr<Node> &context, const QString &query);

    RefPtr<NodeList> m_result;

private:
    inline KWebElementCollectionPrivate() {}
};

KWebElementCollectionPrivate* KWebElementCollectionPrivate::create(const PassRefPtr<Node> &context, const QString &query)
{
    if (!context)
        return 0;
    ...
    KWebElementCollectionPrivate* priv = new KWebElementCollectionPrivate;
    priv->m_result = nodes;
    return priv;
}
...
/*!
    ...
    \since 4.6
    \brief The KWebElementCollection class represents a collection of web elements.
    \preliminary

    Elements in a document can be selected using KWebElement::findAll() or using the
    KWebElement constructor. The collection is composed by choosing all elements in the
    ...
    \code
        KWebElementCollection collection = document.findAll("p");
        foreach (KWebElement paraElement, collection) {
            ...
        }
    \endcode
*/
...
*/
KWebElementCollection::KWebElementCollection()
{
}
...
/*!
    Constructs a copy of \a other.
*/
KWebElementCollection::KWebElementCollection(const KWebElementCollection &other)
    : d(other.d)
{
}
...
*/
KWebElementCollection::KWebElementCollection(const KWebElement &contextElement, const QString &query)
{
    d = QExplicitlySharedDataPointer<KWebElementCollectionPrivate>(KWebElementCollectionPrivate::create(contextElement.m_element, query));
}

/*!
    Assigns \a other to this collection and returns a reference to this collection.
*/
KWebElementCollection &KWebElementCollection::operator=(const KWebElementCollection &other)
{
    d = other.d;
    return *this;
}
...
/*! \fn KWebElementCollection &KWebElementCollection::operator+=(const KWebElementCollection &other)
...
/*!
    ...
    \sa operator+=()
*/
KWebElementCollection KWebElementCollection::operator+(const KWebElementCollection &other) const
{
    KWebElementCollection n = *this; n.d.detach(); n += other; return n;
}
...
/*!
    ...
    \sa operator+=()
*/
void KWebElementCollection::append(const KWebElementCollection &other)
{
    if (!d) {
        *this = other;
        return;
...
*/
int KWebElementCollection::count() const
{
    if (!d)
        return 0;
...
*/
KWebElement KWebElementCollection::at(int i) const
{
    if (!d)
        return KWebElement();
    Node* n = d->m_result->item(i);
    return KWebElement(static_cast<Element*>(n));
}

/*!
    \fn const KWebElement KWebElementCollection::operator[](int position) const

    Returns the element at the specified \a position in the collection.
*/

/*! \fn KWebElement KWebElementCollection::first() const
...
/*! \fn KWebElement KWebElementCollection::last() const
...
*/
QList<KWebElement> KWebElementCollection::toList() const
{
    if (!d)
        return QList<KWebElement>();
    QList<KWebElement> elements;
    int i = 0;
    Node* n = d->m_result->item(i);
    while (n) {
        if (n->isElementNode())
            elements.append(KWebElement(static_cast<Element*>(n)));
        n = d->m_result->item(++i);
    }
    return elements;
}
...
/*!
    \fn KWebElementCollection::const_iterator KWebElementCollection::begin() const
...
/*!
    \fn KWebElementCollection::const_iterator KWebElementCollection::end() const
...
/*!
    \class KWebElementCollection::const_iterator
    \since 4.6
    \brief The KWebElementCollection::const_iterator class provides an STL-style const iterator for KWebElementCollection.

    KWebElementCollection provides STL style const iterators for fast low-level access to the elements.

    KWebElementCollection::const_iterator allows you to iterate over a KWebElementCollection.
*/

/*!
    \fn KWebElementCollection::const_iterator::const_iterator(const const_iterator &other)

    Constructs a copy of \a other.
*/

/*!
    \fn KWebElementCollection::const_iterator::const_iterator(const KWebElementCollection *collection, int index)
    \internal
*/

/*!
    \fn const KWebElement KWebElementCollection::const_iterator::operator*() const

    Returns the current element.
*/

/*!
    \fn bool KWebElementCollection::const_iterator::operator==(const const_iterator &other) const
...
/*!
    \fn KWebElementCollection::const_iterator &KWebElementCollection::const_iterator::operator++()
    ...
    Calling this function on KWebElementCollection::end() leads to undefined results.

    \sa operator--()
*/

/*!
    \fn KWebElementCollection::const_iterator KWebElementCollection::const_iterator::operator++(int)
...
/*!
    ...
    Calling this function on KWebElementCollection::begin() leads to undefined results.
...
/*!
    \fn KWebElementCollection::const_iterator &KWebElementCollection::const_iterator::operator+=(int j)
...
/*!
    \fn KWebElementCollection::const_iterator KWebElementCollection::const_iterator::operator+(int j) const
...
/*!
    \fn int KWebElementCollection::const_iterator::operator-(const_iterator other) const
...
/*!
    \fn KWebElementCollection::iterator KWebElementCollection::begin()
...
/*!
    \fn KWebElementCollection::iterator KWebElementCollection::end()
...
/*!
    \fn KWebElementCollection::const_iterator KWebElementCollection::constBegin() const
...
/*!
    \fn KWebElementCollection::const_iterator KWebElementCollection::constEnd() const
...
/*!
    \class KWebElementCollection::iterator
    \since 4.6
    \brief The KWebElementCollection::iterator class provides an STL-style iterator for KWebElementCollection.

    KWebElementCollection provides STL style iterators for fast low-level access to the elements.

    KWebElementCollection::iterator allows you to iterate over a KWebElementCollection.
*/

/*!
    \fn KWebElementCollection::iterator::iterator(const iterator &other)

    Constructs a copy of \a other.
*/

/*!
    \fn KWebElementCollection::iterator::iterator(const KWebElementCollection *collection, int index)
    \internal
*/

/*!
    \fn const KWebElement KWebElementCollection::iterator::operator*() const

    Returns the current element.
*/

/*!
    \fn bool KWebElementCollection::iterator::operator==(const iterator &other) const
...
/*!
    \fn KWebElementCollection::iterator &KWebElementCollection::iterator::operator++()
...
/*!
    \fn KWebElementCollection::iterator KWebElementCollection::iterator::operator++(int)
...
/*!
    \fn KWebElementCollection::iterator &KWebElementCollection::iterator::operator+=(int j)
...
/*!
    \fn KWebElementCollection::iterator KWebElementCollection::iterator::operator+(int j) const
...
/*!
    \fn int KWebElementCollection::iterator::operator-(iterator other) const
