...
// Function: Arity 0.
template <typename R>
class RunnableAdapter<R(__cdecl*)()> {
 public:
  typedef R (RunType)();
...
class RunnableAdapter<R(__cdecl*)(A1)> {
 public:
...
class RunnableAdapter<R(__cdecl*)(A1, A2)> {
 public:
...
class RunnableAdapter<R(__cdecl*)(A1, A2, A3)> {
 public:
...
class RunnableAdapter<R(__cdecl*)(A1, A2, A3, A4)> {
 public:
  typedef R (RunType)(A1, A2, A3, A4);

  explicit RunnableAdapter(R(__cdecl*function)(A1, A2, A3, A4))
      : function_(function) {
  }
 ...
 private:
  R (__cdecl*function_)(A1, A2, A3, A4);
};
...
template <typename R, typename A1, typename A2, typename A3, typename A4,
    typename A5>
class RunnableAdapter<R(__cdecl*)(A1, A2, A3, A4, A5)> {
 public:
...
class RunnableAdapter<R(__cdecl*)(A1, A2, A3, A4, A5, A6)> {
 public:
...
class RunnableAdapter<R(__cdecl*)(A1, A2, A3, A4, A5, A6, A7)> {
 public:
